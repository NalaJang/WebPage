...
@Component("/hotel/recipt.do")
public class ReciptOfDonationController implements Controller{

	private DonationDao donationDao;
	public ReciptOfDonationController setDonation(DonationDao donationDao) {
	...
	public String execute(Map<String, Object> model) throws Exception {
		...
		if(memberVo == null) {
			...
			return "/hotel/reciptOfDonation.jsp";
		}
	}
