...
<div class = "container">
		...
		<div class = "row content">
			...
			<!-- 이미지 -->
			<div class = "img">
				<img src = "http://localhost:8080/project/hotel/img/${board.image1}">
			</div>
			...
			<!-- 이미지 -->
			<div class = "img">
				<img src = "http://localhost:8080/project/hotel/img/${board.image2}">
			</div>
			...
			<!-- 이미지 -->
			<div class = "img">
				<img src = "http://localhost:8080/project/hotel/img/${board.image3}" alt = "">
			</div>
