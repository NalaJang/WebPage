...
<div class = "container">
			...
			<div class = "row board2">
				<table border = "1" style = "width : 600px;">
					...
					<tr>
						...
						<!-- 제목 -->
						<td style = "width : 200px;"><a href = "campaignReviewContent.do?qseq=${review.qseq}">${review.subject}</a></td>
	...
	<div class = "row btn">
		<button type = "button" onclick = "location.href = 'campaignReviewForm.do'">후기 작성하기</button>
	</div>
